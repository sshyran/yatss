...
//moved from menu.php
$valid_pages=array('events', 'history','cart', 'register', 'admin', 'account', 'tickets', 'checkout', 'message_page', 'box');
$valid_pages_registered=array('events', 'history','cart', 'account');
